      ...
      appBar: PreferredSize(
          ...
          child: Card(
            ...
            child: Padding(
              ...
              child: Text1(text: "Medicine Management", color: const Color(themeColor), size: 30),
            ),
          )
      ),
      body: Scrollbar(
                            ...
                            return GridView.builder(
                              ...
                              itemBuilder: (_,index){
                                return GestureDetector(
                                  onTap: (){
                                    Get.toNamed("/home/${AppStrings.CONTENT_ENTRY}/medicine/catagory",arguments: snapshot.data!.docs[index]["name"]);
                                    // Get.bottomSheet(
                                    //   Container(
                                    //     height: Get.height,
                                    //     color: Colors.white,
